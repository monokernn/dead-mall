...
try{
 ...
 await page.goto('http://127.0.0.1:5195/?test');
 ...
 const report={settings:true,browser:channel+' / SwiftShader',quality:'performance',origin:'http://127.0.0.1:5195',entry:true,pause:true,developmentHooks:hooks,errors,failed};
